...
|---------------|-----------------------------------------------|-------------|
| Sotaro Hikita | [lawofcycles](https://github.com/lawofcycles) | Independent |
...
See [Reporting a Vulnerability](SECURITY.md) for how vulnerabilities in this repository are reported.
